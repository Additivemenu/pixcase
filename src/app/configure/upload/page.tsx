...
const Page = () => {
  ...
  //! what is the architecture of calling this? this pattern not seen before (advanced hook pattern, you give some config to the hook)
  ...
  const onDropAccepted = (acceptedFiles: File[]) => {
    startUpload(acceptedFiles, { configId: undefined }); // ! this is where upload api is called
    setIsDragOver(false);
  };
